...
- Re-run the installed-profile DSH plugin composition and real-runtime loading
  checks for the complete 135-component bundle, including per-agent scoped
  shells and the browser client entrypoint.
